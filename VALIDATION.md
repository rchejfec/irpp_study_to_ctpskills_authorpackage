...
| 2026-07-08 | Walkthrough TEER color mapping and allGreen highlight logic matches Python screen boundaries | Visual check of D_walkthrough.html for Estevan water treatment delta=-2 (yellow/pass), Neepawa transit delta=1 (green/pass), taxi delta=2 (red/fail) | Yellow and Green dots correctly colored; allGreen correctly highlights both yellow and green passing TEERs | |
| 2026-07-08 | Walkthrough notes refined (intuitive aspirational prefixes, NOCs in small tooltips, grouped 'Not viable due to...' notes) | Verify generated json and check right panel in D_walkthrough.html for Oxford 75101 and Neepawa 73300 | Aspirational notes use new prefix; failures grouped under 'Not viable due to...'; occupation tooltips show NOCs in 7.5px font | |
| 2026-07-08 | Walkthrough notes styling refined (combined Qual failures, >3 collapse to 'and N more', tooltip on full title with inline NOC list) | Inspect JSON output and verify right panel rendering in D_walkthrough.html for Oxford 75101 and Neepawa 73300 | Qual exclusions combined under 'Not viable: no local presence and/or alignment...'; note titles >3 collapse correctly; tooltip on title triggers full inline NOC list in 7.5px font | |
| 2026-07-08 | Non-viable notes prefixed with 'Not viable: <reason>'; title tooltips show bold NOCs, full names, and italicized ranks | Verify generated JSON templates and check Tippy.js content rendering on D_walkthrough.html for Oxford 75101 and Neepawa 73300 | Non-viable notes use 'Not viable: ...'; hover tooltips on note titles display formatted NOCs and ranks | |
| 2026-07-08 | TEER exclusions split into 'typical training requirements are lower' vs 'requires significant additional training' | Check Neepawa 73300 and Channel-Port aux Basques walkthrough json and views | Exclusions for positive delta show 'typical training requirements are lower'; exclusions for negative delta show 'requires significant additional training' | |
| 2026-07-08 | Qualitative exclusions grammar corrected; Qual failures mapped to red circle; viable notes conditionally merged if notes > 5 | Verify generated JSON and deriveFilters function in D_walkthrough.html for Oxford 75101 and Neepawa 73300 | Qual note uses 'lack of alignment'; Qual failure dots colored red; Neepawa notes > 5 collapse to 'Viable or may require...' combined notes | |
| 2026-07-08 | Interactive screening dot tooltips display raw values (TEER, Wage, COPS, AI, Qual details) and provincial workers | Verify D_walkthrough.html hovers in desktop/compact views for various pairs | Hovering over any screening dot displays formatted values, pass/fail status reason, and provincial worker count | |
| 2026-07-15 | Figure I gap counts (bars + "+N more" marker) are data-true: independent recount of strict Skills-domain gaps from lq_skills.csv matches the displayed count for all 69 pairs, and every one of the 18 zero-gap pathways has zero target-above-average skills missing from the source (near-twins, incl. the labourer cluster — not a pipeline bug) | `uv run python validation/check_I_zero_gaps.py` | PASS: 0/69 mismatches; 18 zero-gap pairs, all `of_those_missing_from_source`=0; evidence `validation/I_zero_gap_pairs.csv` | |
